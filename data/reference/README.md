...
## Re=100 Unsteady Reference — `unsteady_reference_re100.mat`

Same solver and grid as the Re=10 case, but μ = 0.0005 (Re = 100). Kármán vortex shedding expected (St ≈ 0.30). Generated by [`gen_unsteady_reference_re100.py`](gen_unsteady_reference_re100.py).
...
**Validity:** flux imbalance 0.0%, interior max\|div(u)\| = 0.185 (< 0.5). Inlet corner cell shows \|BC error\| ≈ 0.024 at t = 0.5 s — collocated-grid artefact where wall no-slip overwrites the inlet profile; does not affect mass conservation.

**Colorbar ranges used in figures:** u ∈ [−0.2, 1.4], v ∈ [−0.8, 0.8], p ∈ [−0.6, 3.0]

### Animation (51 frames, 120 ms/frame)

![Re=100 reference animation](figures/re100_animation.gif)
